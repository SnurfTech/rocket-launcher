package com.snurftech.rocketlauncher;
...
import com.snurftech.rocketlauncher.init.RocketLauncherModTabs;
...
@Mod("rocket_launcher")
public class RocketLauncherMod {
	public static final Logger LOGGER = LogManager.getLogger(RocketLauncherMod.class);
	public static final String MODID = "rocket_launcher";

	public RocketLauncherMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		RocketLauncherModItems.REGISTRY.register(modEventBus);
		RocketLauncherModEntities.REGISTRY.register(modEventBus);
		RocketLauncherModTabs.REGISTRY.register(modEventBus);
